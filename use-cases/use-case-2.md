...
As an HR advisor I want to produce a report on the salary of all employees in a given department so that I can support financial reporting of the organisation.
### Scope
...
1. Finance request salary information for all roles in a given department.
